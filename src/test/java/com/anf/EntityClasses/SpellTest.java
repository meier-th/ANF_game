 ...
 *
 * This covers the core damage/chakra calculation that drives every fight action.
 * Formula:  damage = (baseDamage + level * damagePerLevel) * (1 - resistance)
 *           chakra = baseChakraConsumption - level * chakraConsumptionPerLevel
 */
public class SpellTest {
    ...
    public void performAttack_chakraCostDecreasesWithLevel() {
        ...
        assertTrue("Higher level should cost less chakra",
