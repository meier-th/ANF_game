 ...
 *
 * The turn order for a bare 1-v-1 (no summoned animals) is:
 *   0 → fighter1, 1 → fighter2, then wraps back.
 */
public class FightPvpTurnTest {
    ...
    public void setUp() {
        ...
        Character char1 = new Character(0.1f, 100, 10, 30);
        char1.setUser(fighter1);
        fighter1.setCharacter(char1);

        Character char2 = new Character(0.1f, 100, 10, 30);
