...
/**
 * Unit tests for {@link AuthController} covering registration,
 * session checks, and reserved-name guard.
 */
public class AuthControllerTest {
    ...
    public void setUp() {
        ...
        controller = new AuthController(
                userService, roleRepository, characterService,
                statsService, wsController, authManager
        );
    ...
    public void registration_createsUser_onHappyPath() {
        ...
        verify(characterService).addCharacter(any(Character.class));
    ...
    public void registration_assignsInitialStatsAndCharacter() {
        ...
        Character ch = charCaptor.getValue();
