...
public class NinjaAnimal extends Creature implements Serializable {
    ...
    static {
        ...
        NinjaAnimal rodstvennik1 = new NinjaAnimal("Тётя Срака", NinjaAnimalRace.DALNIY_RODSTVENNIK, 18, 250, 1);
        NinjaAnimal rodstvennik2 = new NinjaAnimal("Дядя Бафомет", NinjaAnimalRace.DALNIY_RODSTVENNIK, 55, 370, 10);
