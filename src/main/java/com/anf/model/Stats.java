...
public class Stats {
  ...
  /**
   * Number of fights during which user died Death occurs when a character died in battle against
   * AI, but his team won
   */
  @Column(nullable = false)
  private int deaths;
  ...
  /** Setter {@link Stats#fights} */
  public void setFights(int fights) {
    this.fights = fights;
  }

  /** Setter {@link Stats#wins} */
  ...
  /** Setter {@link Stats#losses} */
  public void setLosses(int losses) {
    this.losses = losses;
  }

  /** Setter {@link Stats#deaths} */
  public void setDeaths(int deaths) {
    this.deaths = deaths;
  }

  /** Getter {@link Stats#rating} */
  public int getRating() {
    return this.rating;
  }

  /** Getter {@link Stats#fights} */
  public int getFights() {
    return this.fights;
  }

  /** Getter {@link Stats#wins} */
  public int getWins() {
    return this.wins;
  }

  /** Getter {@link Stats#losses} */
  public int getLosses() {
    return this.losses;
  }

  /** Getter {@link Stats#deaths} */
