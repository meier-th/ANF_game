...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  public CorsConfigurationSource corsConfigurationSource() {
    ...
    corsConfiguration.setAllowedOrigins(
        ImmutableList.of("*")); // * because I dunno my url after forwarding
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.addFilterAfter(
            new OAuth2ClientContextFilter(), AbstractPreAuthenticatedProcessingFilter.class)
    ...
    http.csrf()
        ...
        .authorizeRequests()
        .antMatchers("/confirm")
        .hasAnyAuthority("NEWVK", "NEWGoogle")
        .antMatchers("/checkCookies")
        .permitAll()
